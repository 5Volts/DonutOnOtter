...
HD_PWD='C:/Users/tanru/OneDrive/Desktop/FinalProjectMulti/FinalProjectMulti.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OTTER_Wrapper_VGA80x60.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OTTER_Wrapper_VGA80x60.tcl
