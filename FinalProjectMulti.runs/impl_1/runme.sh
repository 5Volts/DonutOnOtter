...
HD_PWD='C:/Users/tanru/OneDrive/Desktop/FinalProjectMulti/FinalProjectMulti.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OTTER_Wrapper_VGA80x60.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OTTER_Wrapper_VGA80x60.tcl -notrace
